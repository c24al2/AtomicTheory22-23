...
public class SampleOmniDrive extends OmniDrive {
    ...
    public static TrajectoryVelocityConstraint getVelocityConstraint(double maxVel, double maxAngularVel, List<Pose2d> wheelPositions) {
        return new MinVelocityConstraint(Arrays.asList(
                new AngularVelocityConstraint(maxAngularVel),
                new OmniVelocityConstraint(maxVel, wheelPositions)
        ));
    }
